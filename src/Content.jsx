...
function Content({ ProductDetails, cartCount, setCartCount }) {
        ...
        <div className="col mb-5">
            <div className="card h-100">
                ...
                <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <div className="text-center">{ ProductDetails.BtnValue === "View Options" ?
                    <a className="btn btn-outline-dark mt-auto" href="#">{ ProductDetails.BtnValue }</a> :
